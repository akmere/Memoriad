...
public class RecyclerAdapterCards extends RecyclerView.Adapter<RecyclerAdapterCards.SecondViewHolder>{

    ArrayList<cardsResult> list;
    static moveResultData mMoveResultData;

    public RecyclerAdapterCards(ArrayList<cardsResult> list){
        this.list = list;
    }
